...
CSV_FILE_PATH = "D:/pythonproject/Cefixime_feature_abstraction/Cefixime_data/Cefixime/cefixime_bondformation_alldata.csv"
...
df1.to_csv('./loss_data1.csv', index=False)
